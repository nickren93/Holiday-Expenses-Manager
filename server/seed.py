...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        h1 = Holiday(name="4th of July",  description="Independence Day, known colloquially as \
                     ...
                     United States of America.", year = 2021)
        h2 = Holiday(name="Memorial Day", description="Memorial Day is a federal holiday in\
                     ...
                     the unofficial beginning of summer in the United States.", year = 2020)
        h3 = Holiday(name="Labor Day", description="Labor Day is a federal holiday in the \
                     ...
                     development and achievements in the United States.", year = 2020)
        h4 = Holiday(name="New Year's Day", description="In the Gregorian calendar, New \
                     ...
                     the northern winter solstice.", year = 2023)
        h5 = Holiday(name="Christmas Day", description="Christmas is an annual festival \
                     ...
                     as a religious and cultural celebration among billions of people around the world.", year = 2023)
        h6 = Holiday(name="Thanksgiving", description="Thanksgiving is a federal holiday in the \
                     ...
                     Thanksgiving can occur is November 22; the latest is November 28.", year = 2024)
        h7 = Holiday(name="4th of July",  description="Independence Day, known colloquially as \
                     the Fourth of July, is a federal holiday in the United States which commemorates \
                     the adoption of the Declaration of Independence on July 4, 1776, establishing the \
                     United States of America.", year = 2025)
        h8 = Holiday(name="Memorial Day", description="Memorial Day is a federal holiday in\
                      the United States for mourning the U.S. military personnel who died while serving \
                     in the United States Armed Forces. It is observed on the last Monday of May. It is \
                     the unofficial beginning of summer in the United States.", year = 2022)
        
        db.session.add_all([h1, h2, h3, h4, h5, h6, h7, h8])
        db.session.commit()
        ...
        e1 = Expense(amount=20.50, date="2024-11-28", note="Cost for Uber to/from friends house", \
                     user=u1, holiday=h6, category=c1)
        e2 = Expense(amount=150.00, date="2023-01-01", note="Cost for Dinner", user=u1, holiday=h4, category=c2)
        e3 = Expense(amount=300.00, date="2020-09-02",  note="Cost for UFC event tickets", user=u1, \
                     holiday=h3, category=c3)
        e4 = Expense(amount=70.00, date="2024-11-28", note="Cost for Uber to/from NYC", \
                     user=u1, holiday=h6, category=c1)
        e5 = Expense(amount=200.00, date="2023-12-25", note="Cost for Christmas gifts", user=u2, \
                     holiday=h5, category=c4)
        e6 = Expense(amount=60.00, date="2020-05-25", note="Cost for movie tickets", user=u2, \
                     holiday=h2, category=c3)
        e7 = Expense(amount=20.00, date="2023-01-01", note="Cost for ice-cream", user=u2, holiday=h4, category=c2)
        e8 = Expense(amount=20.50, date="2021-07-04", user=u3, holiday=h1, category=c3)
